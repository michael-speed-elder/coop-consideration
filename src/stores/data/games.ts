...
const data: Game[] = [
  {
    ...
    cons: ['New content via DLC', 'Potentially repetitve'],
    storeUrl:
  ...
  },
  {
    ...
    pros: ['Guns. Lots of guns.', 'Challenging', 'Dodge city'],
  ...
  },
  {
    ...
    pros: ['Nostalgia', 'Arcade-cabinet', 'Overwhelmingly positive (Steam)'],
  ...
  },
  {
    ...
    pros: ['Intellectually stimulating', 'Controller-friendly'],
  ...
  },
  {
    ...
    pros: ['Teamwork required', 'Sci-fi', 'Challenging', 'Controller-friendly'],
    cons: ['No crossplay', 'Quite frenetic at higher difficulties'],
    storeUrl:
  ...
  },
  {
    ...
    pros: ['MMO', 'Piracy', 'Sailing', 'Immersive atmosphere', 'Crossplay'],
  ...
  },
  {
    ...
    cons: ['Early Access', 'Maybe too real'],
  ...
  },
  {
    ...
    cons: ['Less exciting with fewer folks', 'Alomo looking kinda sus'],
    videos: [
